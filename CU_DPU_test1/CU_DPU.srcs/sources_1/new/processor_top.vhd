...
architecture processor_top of processor_top is
  ...
  signal writedata, dataadr, dataadrinp: STD_LOGIC_VECTOR(31 downto 0);
  ...
  begin     
      ...
      out_port_1 <= instr;
      dataadrinp <= "0000000000000000"&instr(15 downto 0);
	  ...
	  dmem1: dmem generic map(32) port map( clk => clk, we => memwrite, a => dataadrinp, 
